...
namespace BlackStartX.GestureManager.Editor.Modules.Vrc3
{
    public static class ModuleVrc3Styles
    {
        ...
        internal static Texture2D Expressions => !_expressions ? _expressions = EResources.Load<Texture2D>("BSX_GM_Expressions") : _expressions;
        internal static Texture2D Tools => !_tools ? _tools = EResources.Load<Texture2D>("BSX_GM_Tools") : _tools;
        internal static Texture2D Back => !_back ? _back = EResources.Load<Texture2D>("BSX_GM_Back") : _back;
        internal static Texture2D BackHome => !_backHome ? _backHome = EResources.Load<Texture2D>("BSX_GM_BackHome") : _backHome;
        internal static Texture2D Default => !_default ? _default = EResources.Load<Texture2D>("BSX_GM_Default") : _default;
        internal static Texture2D Gear => !_gear ? _gear = EResources.Load<Texture2D>("BSX_GM_Gear") : _gear;
        internal static Texture2D Reset => !_reset ? _reset = EResources.Load<Texture2D>("BSX_GM_Reset") : _reset;
        internal static Texture2D TwoAxis => !_twoAxis ? _twoAxis = EResources.Load<Texture2D>("BSX_GM_2_Axis") : _twoAxis;
        internal static Texture2D FourAxis => !_fourAxis ? _fourAxis = EResources.Load<Texture2D>("BSX_GM_4_Axis") : _fourAxis;
        internal static Texture2D Radial => !_radial ? _radial = EResources.Load<Texture2D>("BSX_GM_Radial") : _radial;
        internal static Texture2D Toggle => !_toggle ? _toggle = EResources.Load<Texture2D>("BSX_GM_Toggle") : _toggle;
        internal static Texture2D ResetHeight => !_resetHeight ? _resetHeight = EResources.Load<Texture2D>("BSX_GM_Reset_Height") : _resetHeight;
        internal static Texture2D AvatarHeight => !_avatarHeight ? _avatarHeight = EResources.Load<Texture2D>("BSX_GM_Avatar_Height") : _avatarHeight;
        internal static Texture2D ReleasePoses => !_releasePoses ? _releasePoses = EResources.Load<Texture2D>("BSX_GM_Release_Poses") : _releasePoses;
        internal static Texture2D RunningParam => !_runningParam ? _runningParam = EResources.Load<Texture2D>("BSX_GM_Running_Param") : _runningParam;
        internal static Texture2D AxisUp => !_axisUp ? _axisUp = EResources.Load<Texture2D>("BSX_GM_Axis_Up") : _axisUp;
        internal static Texture2D AxisRight => !_axisRight ? _axisRight = EResources.Load<Texture2D>("BSX_GM_Axis_Right") : _axisRight;
        internal static Texture2D AxisDown => !_axisDown ? _axisDown = EResources.Load<Texture2D>("BSX_GM_Axis_Down") : _axisDown;
        internal static Texture2D AxisLeft => !_axisLeft ? _axisLeft = EResources.Load<Texture2D>("BSX_GM_Axis_Left") : _axisLeft;
        internal static Texture2D SupportLike => !_supportLike ? _supportLike = EResources.Load<Texture2D>("BSX_GM_Support_Like") : _supportLike;
        internal static Texture2D SupportGold => !_supportGold ? _supportGold = EResources.Load<Texture2D>("BSX_GM_Support_Gold") : _supportGold;
        internal static Texture2D SupportHeart => !_supportHeart ? _supportHeart = EResources.Load<Texture2D>("BSX_GM_Support_Heart") : _supportHeart;
        internal static Texture2D ToolCamera => !_toolCamera ? _toolCamera = EResources.Load<Texture2D>("BSX_GM_Tool_Camera") : _toolCamera;
        internal static Texture2D ToolClick => !_toolClick ? _toolClick = EResources.Load<Texture2D>("BSX_GM_Tool_Click") : _toolClick;
        internal static Texture2D ToolPose => !_toolPose ? _toolPose = EResources.Load<Texture2D>("BSX_GM_Tool_Pose") : _toolPose;
        internal static Texture2D Earmuffs => !_earmuffs ? _earmuffs = EResources.Load<Texture2D>("BSX_GM_Earmuffs") : _earmuffs;
        internal static Texture2D FallingSpeed => !_fallingSpeed ? _fallingSpeed = EResources.Load<Texture2D>("BSX_GM_FallingSpeed") : _fallingSpeed;
        internal static Texture2D FullBody => !_fullBody ? _fullBody = EResources.Load<Texture2D>("BSX_GM_FullBody") : _fullBody;
        internal static Texture2D Generic => !_generic ? _generic = EResources.Load<Texture2D>("BSX_GM_Generic") : _generic;
        internal static Texture2D GestureLeftWeight => !_gestureLeftWeight ? _gestureLeftWeight = EResources.Load<Texture2D>("BSX_GM_GestureLeftWeight") : _gestureLeftWeight;
        internal static Texture2D GestureRightWeight => !_gestureRightWeight ? _gestureRightWeight = EResources.Load<Texture2D>("BSX_GM_GestureRightWeight") : _gestureRightWeight;
        internal static Texture2D Grounded => !_grounded ? _grounded = EResources.Load<Texture2D>("BSX_GM_Grounded") : _grounded;
        internal static Texture2D HandsOnly => !_handsOnly ? _handsOnly = EResources.Load<Texture2D>("BSX_GM_HandsOnly") : _handsOnly;
        internal static Texture2D HeadHands => !_headHands ? _headHands = EResources.Load<Texture2D>("BSX_GM_HeadHands") : _headHands;
        internal static Texture2D PoseIK => !_poseIk ? _poseIk = EResources.Load<Texture2D>("BSX_GM_Pose_IK") : _poseIk;
        internal static Texture2D MuteSelf => !_muteSelf ? _muteSelf = EResources.Load<Texture2D>("BSX_GM_MuteSelf") : _muteSelf;
        internal static Texture2D Seated => !_seated ? _seated = EResources.Load<Texture2D>("BSX_GM_Seated") : _seated;
        internal static Texture2D PoseT => !_poseT ? _poseT = EResources.Load<Texture2D>("BSX_GM_Pose_T") : _poseT;
        internal static Texture2D Upright => !_upright ? _upright = EResources.Load<Texture2D>("BSX_GM_Upright") : _upright;
        internal static Texture2D Velocity => !_velocity ? _velocity = EResources.Load<Texture2D>("BSX_GM_Velocity") : _velocity;
        internal static Texture2D Visemes => !_visemes ? _visemes = EResources.Load<Texture2D>("BSX_GM_Visemes") : _visemes;
        internal static Texture2D VRMode => !_vRMode ? _vRMode = EResources.Load<Texture2D>("BSX_GM_VRMode") : _vRMode;
        internal static Texture2D Afk => !_afk ? _afk = EResources.Load<Texture2D>("BSX_GM_AFK") : _afk;
        internal static Texture2D HeadChops => !_headChops ? _headChops = EResources.Load<Texture2D>("BSX_GM_HeadChop") : _headChops;
        internal static Texture2D FourPoint => !_fourPoint ? _fourPoint = EResources.Load<Texture2D>("BSX_GM_FourPoint") : _fourPoint;
