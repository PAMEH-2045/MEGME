...
namespace BlackStartX.GestureManager.Editor.Modules.Vrc3
{
    public static class RadialMenuUtility
    {
        public static class Colors
        {
            ...
            public static readonly Color RadialInner = new(0.21f, 0.24f, 0.27f, 0.9f);
            ...
            {
                private Color GetPref() => ColorUtility.TryParseHtmlString(Settings.Get<string>(_key), out var color) ? color : Reset;
                //private Color GetPref() => ColorUtility.TryParseHtmlString(EditorPrefs.GetString(_key), out var color) ? color : Reset;

                private void SetPref(Color color) => Settings.Set(_key, $"#{ColorUtility.ToHtmlStringRGBA(color)}");
                ...
                public readonly Vrc3Param Alpha; //
                ...
                public CustomColor(string editorPrefKey, Color defaultColor)
                {
                    ...
                    Alpha = new Vrc3Param(null, AnimatorControllerParameterType.Float, OnAlphaChange); //
                    Color = GetPref();
                }
